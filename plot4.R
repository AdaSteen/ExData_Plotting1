...
plot(dat1$datetime,dat1$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(dat1$datetime,dat1$Global_reactive_power, type = "l", ylab = "Global reactive Power", xlab = "datetime")
}